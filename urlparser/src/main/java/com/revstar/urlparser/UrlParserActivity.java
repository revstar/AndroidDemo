...
public class UrlParserActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<String>urlTestUrl;
            ...
            public void run() {
                try {
                  if (NetUtils.isTMUrl(url)){
                      urlTestUrl=ParserUtils.parserTMUrl(html);
//                      urlList= ParserUtils.parserTMUrl(html);
                  }else if (NetUtils.isJDUrl(url)){
//                      urlList=ParserUtils.parserJDUrl(html);
                  }else if (NetUtils.isWDUrl(html)){
//                      urlList=ParserUtils.parserWDUrl(html);
                  }else if (NetUtils.isVIPUrl(html)){
//                      urlList=ParserUtils.parserVIPHUrl(html);
                  }
                  if (mMyHandler!=null){
